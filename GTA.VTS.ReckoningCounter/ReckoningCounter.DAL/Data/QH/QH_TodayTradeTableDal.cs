...
{
    /// <summary>
    /// 数据访问类QH_TodayTradeTableDal。
    /// </summary>
    public class QH_TodayTradeTableDal
    {
        #region  成员方法
        ...
        public bool Exists(string TradeNumber)
        {
            ...
            strSql.Append("select count(1) from QH_TodayTradeTable where TradeNumber=@TradeNumber ");
        ...
        /// 增加一条数据
        /// </summary>
        public void Add(QH_TodayTradeTableInfo model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public void Delete(string TradeNumber)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from QH_TodayTradeTable ");
            strSql.Append(" where TradeNumber=@TradeNumber ");
            Database db = DatabaseFactory.CreateDatabase();
            DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());
            db.AddInParameter(dbCommand, "TradeNumber", DbType.AnsiString, TradeNumber);
        ...
        /// 获得数据列表  
        /// </summary>
        public List<QH_TodayTradeTableInfo> GetListArray(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            strSql.Append(" FROM QH_TodayTradeTable ");
            if (strWhere.Trim() != "")
            {
        ...
        ///// <returns></returns>
        //public List<QH_TodayTradeTableInfo> PagingQH_TodayTradeByFilter(PagingProceduresInfo pageProcInfo, out int total)
        //{
        //    List<QH_TodayTradeTableInfo> list = new List<QH_TodayTradeTableInfo>();
        //    Database db = DatabaseFactory.CreateDatabase();
