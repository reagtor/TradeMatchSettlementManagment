...
namespace ReckoningCounter.Model
{
    /// <summary>
    /// Title: 现货当日成交实体类
    /// Desc: 现货当日成交实体类XH_TodayTradeTable 。(属性说明自动提取数据库字段的描述信息)
    /// Create BY：李健华
    /// Create Date：2009-10-15
    /// </summary>
    [DataContract]
    public class XH_TodayTradeTableInfo
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public XH_TodayTradeTableInfo()
        { }
        ...
        #endregion
        #region TradeCapitalAmount 成交金额(成交价格*成交总量)
        private decimal tradeCapitalAmount;
        /// <summary>
        /// 成交金额(成交价格*成交总量)
        /// </summary>
        [DataMember]
        public decimal TradeCapitalAmount
        {
            get
            {
                return tradeCapitalAmount;
            }
            set
            {
                tradeCapitalAmount = value;
            }
        }
        #endregion
