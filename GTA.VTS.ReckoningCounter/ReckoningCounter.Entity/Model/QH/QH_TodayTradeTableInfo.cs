...
namespace ReckoningCounter.Model
{
    /// <summary>
    /// Title: 期货当日成交实体类
    /// Desc: 期货当日成交实体类QH_TodayTradeTable
    /// Create BY：李健华
    /// Create Date：2009-10-15
    /// </summary>
    [DataContract]
    public class QH_TodayTradeTableInfo
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public QH_TodayTradeTableInfo()
        { }
        ...
        #endregion
        #region TradeAccount 用于期货成交的交易账号(即期货持仓帐户--即或证券股东代码/商品期货交易编码))(外键UA_UserAccountAllocationTable)
        private string tradeAccount;
        /// <summary>
        /// 用于期货成交的交易账号(即期货持仓帐户--即或证券股东代码/商品期货交易编码))(外键UA_UserAccountAllocationTable)
        /// </summary>
        [DataMember]
        ...
        #endregion
        #region CapitalAccount 期货成交资金帐户(即股指期货资金帐号/商品期货资金帐号)(外键UA_UserAccountAllocationTable)
        private string capitalAccount;
        /// <summary>
        /// 期货成交资金帐户(即股指期货资金帐号/商品期货资金帐号)(外键UA_UserAccountAllocationTable)
        /// </summary>
        [DataMember]
