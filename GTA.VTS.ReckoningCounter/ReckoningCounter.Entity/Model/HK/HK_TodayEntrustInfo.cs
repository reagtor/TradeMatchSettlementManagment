...
{
    /// <summary>
    /// 港股当日委托实体类HK_TodayEntrustInfo 。(属性说明自动提取数据库字段的描述信息)
    /// Create BY：李健华
    /// Create Date：2009-10-15
    /// </summary>
    //[Serializable]
    public class HK_TodayEntrustInfo
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public HK_TodayEntrustInfo()
        { }
        #region Model
        ...
        private string _callbackchannlid;
        ...
        {
            set { _cancellogo = value; }
            get { return _cancellogo; }
        }
        /// <summary>
        ...
        /// <summary>
        /// 用于委托的交易账户(即港股持仓帐户--即或证券股东代码/港股股东代码))(外键UA_UserAccountAllocationTable)
        /// </summary>
        ...
        {
            set { _callbackchannlid = value; }
            get { return _callbackchannlid; }
        }
        /// <summary>
        /// 委托单的MC机器随机编码单号
        /// </summary>
