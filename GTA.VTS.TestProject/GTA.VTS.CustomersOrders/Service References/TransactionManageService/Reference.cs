...
namespace GTA.VTS.CustomersOrders.TransactionManageService {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="TransactionManageService.ITransactionManage")]
    public interface ITransactionManage {
        ...
        System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo> BatchAddTransaction(out string message, int Number, GTA.VTS.CustomersOrders.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd);
        ...
        System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo> BatchAddTransactionList(out string message, System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo> tUserInfo, GTA.VTS.CustomersOrders.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd);
        ...
        bool UpdateTransactionAll(out string message, GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo userInfo, string MLoginName, string ManagerPWd);
        ...
        bool BatchDelectTransaction(out string message, System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo> userInfo, string MLoginName, string ManagerPWd);
        ...
        GTA.VTS.CustomersOrders.TransactionManageService.CT_Counter TransactionConfirm(out string message, int UserID, string PassWord);
        ...
        bool AddFund(out string message, int UserID, GTA.VTS.CustomersOrders.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd);
        ...
        bool ClearTrialData(out string message, GTA.VTS.CustomersOrders.TransactionManageService.PersonalizationCapital cap, string LoginName, string PassWord);
        ...
        bool PersonalizationCapital(out string message, GTA.VTS.CustomersOrders.TransactionManageService.PersonalizationCapital cap, string LoginName, string PassWord);
        ...
        GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo AddTransactionFP(out System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.AccountEntity> l_AccountEntity, out string message, string MLoginName, string ManagerPWd, GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo UserInfo, GTA.VTS.CustomersOrders.TransactionManageService.InitFund initfund);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITransactionManage/AdminFindTraderCapitalAccountInfoByIDFP", ReplyAction="http://tempuri.org/ITransactionManage/AdminFindTraderCapitalAccountInfoByIDFPResp" +
            "onse")]
        System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.TradersAccountCapitalInfo> AdminFindTraderCapitalAccountInfoByIDFP(out string strErrorMessage, string adminId, string adminPassword, string traderID);
        ...
        bool AddFundFP(out string mess, GTA.VTS.CustomersOrders.TransactionManageService.UM_FundAddInfo model);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITransactionManageChannel : GTA.VTS.CustomersOrders.TransactionManageService.ITransactionManage, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TransactionManageClient : System.ServiceModel.ClientBase<GTA.VTS.CustomersOrders.TransactionManageService.ITransactionManage>, GTA.VTS.CustomersOrders.TransactionManageService.ITransactionManage {
        ...
        public System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo> BatchAddTransaction(out string message, int Number, GTA.VTS.CustomersOrders.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd) {
            return base.Channel.BatchAddTransaction(out message, Number, initFund, MLoginName, ManagerPWd);
        }
        
        public System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo> BatchAddTransactionList(out string message, System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo> tUserInfo, GTA.VTS.CustomersOrders.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd) {
        ...
        public bool UpdateTransactionAll(out string message, GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo userInfo, string MLoginName, string ManagerPWd) {
            return base.Channel.UpdateTransactionAll(out message, userInfo, MLoginName, ManagerPWd);
        }
        
        public bool BatchDelectTransaction(out string message, System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo> userInfo, string MLoginName, string ManagerPWd) {
            return base.Channel.BatchDelectTransaction(out message, userInfo, MLoginName, ManagerPWd);
        }
        
        public GTA.VTS.CustomersOrders.TransactionManageService.CT_Counter TransactionConfirm(out string message, int UserID, string PassWord) {
            return base.Channel.TransactionConfirm(out message, UserID, PassWord);
        }
        
        public bool AddFund(out string message, int UserID, GTA.VTS.CustomersOrders.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd) {
            return base.Channel.AddFund(out message, UserID, initFund, MLoginName, ManagerPWd);
        }
        
        public bool ClearTrialData(out string message, GTA.VTS.CustomersOrders.TransactionManageService.PersonalizationCapital cap, string LoginName, string PassWord) {
            return base.Channel.ClearTrialData(out message, cap, LoginName, PassWord);
        }
        
        public bool PersonalizationCapital(out string message, GTA.VTS.CustomersOrders.TransactionManageService.PersonalizationCapital cap, string LoginName, string PassWord) {
            return base.Channel.PersonalizationCapital(out message, cap, LoginName, PassWord);
        }
        
        public GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo AddTransactionFP(out System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.AccountEntity> l_AccountEntity, out string message, string MLoginName, string ManagerPWd, GTA.VTS.CustomersOrders.TransactionManageService.UM_UserInfo UserInfo, GTA.VTS.CustomersOrders.TransactionManageService.InitFund initfund) {
            return base.Channel.AddTransactionFP(out l_AccountEntity, out message, MLoginName, ManagerPWd, UserInfo, initfund);
        }
        
        public System.Collections.Generic.List<GTA.VTS.CustomersOrders.TransactionManageService.TradersAccountCapitalInfo> AdminFindTraderCapitalAccountInfoByIDFP(out string strErrorMessage, string adminId, string adminPassword, string traderID) {
        ...
        public bool AddFundFP(out string mess, GTA.VTS.CustomersOrders.TransactionManageService.UM_FundAddInfo model) {
