...
namespace ReckoningCounter.PushBackTest.DoAccountService {
    ...
    public partial class HighLowRangeValue : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private ReckoningCounter.PushBackTest.DoAccountService.HKRangeValue HongKongRangeValueField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private decimal LowRangeValueField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private GTA.VTS.Common.CommonObject.Types.HighLowRangeType RangeTypeField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ReckoningCounter.PushBackTest.DoAccountService.HKRangeValue HongKongRangeValue {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public GTA.VTS.Common.CommonObject.Types.HighLowRangeType RangeType {
            get {
    ...
    public partial class HKRangeValue : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private GTA.VTS.Common.CommonObject.Types.HKValidPriceType HKValidPriceTypeField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public GTA.VTS.Common.CommonObject.Types.HKValidPriceType HKValidPriceType {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="DoAccountService.IAccountAndCapitalManagement")]
    public interface IAccountAndCapitalManagement {
        ...
        bool SingleTraderOpenAccount(out string outMessage, System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.AccountEntity> accounts);
        ...
        bool VolumeTraderOpenAccount(out string outMessage, System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.AccountEntity> accounts);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountAndCapitalManagement/DeleteVolumeTraderAccount", ReplyAction="http://tempuri.org/IAccountAndCapitalManagement/DeleteVolumeTraderAccountResponse" +
            "")]
        bool DeleteVolumeTraderAccount(out string outMessage, System.Collections.Generic.List<string> userIDs);
        ...
        bool FreezeAccount(out string outMessage, System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.FindAccountEntity> accounts);
        ...
        bool ThawAccount(out string outMessage, System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.FindAccountEntity> accounts);
        ...
        System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.AccountFindResultEntity> FindAccount(out string outMessage, string traderId, string password);
        ...
        System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.CM_BreedClass> FindTradePrivileges(out string outMessage, string traderId, string password);
        ...
        bool AddCapital(out string outMessage, [System.ServiceModel.MessageParameterAttribute(Name="addCapital")] ReckoningCounter.PushBackTest.DoAccountService.AddCapitalEntity addCapital1);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountAndCapitalManagement/TwoAccountsFreeTransferFunds", ReplyAction="http://tempuri.org/IAccountAndCapitalManagement/TwoAccountsFreeTransferFundsRespo" +
            "nse")]
        bool TwoAccountsFreeTransferFunds(out string outMessage, ReckoningCounter.PushBackTest.DoAccountService.FreeTransferEntity freeTransfer, GTA.VTS.Common.CommonObject.Types.CurrencyType currencyType);
        ...
        bool FaultRecoveryReckoning(out string errorMsg, System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.QH_TodaySettlementPriceInfo> list);
        ...
        long GetSpotMaxOrderAmount(out string outMessage, string TraderId, float OrderPrice, string Code, ReckoningCounter.PushBackTest.DoAccountService.TypesOrderPriceType orderPriceType);
        ...
        long GetFutureMaxOrderAmount(out string outMessage, string TraderId, float OrderPrice, string Code, ReckoningCounter.PushBackTest.DoAccountService.TypesOrderPriceType orderPriceType);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountAndCapitalManagement/GetHighLowRangeValueByCommodityCo" +
            ...
            "deResponse")]
        ReckoningCounter.PushBackTest.DoAccountService.HighLowRangeValue GetHighLowRangeValueByCommodityCode(string code, decimal orderPrice);
        ...
        long GetHKMaxOrderAmount(out string outMessage, string TraderId, float OrderPrice, string Code, GTA.VTS.Common.CommonObject.Types.HKPriceType orderPriceType);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountAndCapitalManagement/GetHKHighLowRangeValueByCommodity" +
            ...
            "CodeResponse")]
        ReckoningCounter.PushBackTest.DoAccountService.HighLowRangeValue GetHKHighLowRangeValueByCommodityCode(string code, decimal orderPrice, GTA.VTS.Common.CommonObject.Types.HKPriceType priceType, GTA.VTS.Common.CommonObject.Types.TransactionDirection tranType);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountAndCapitalManagement/AdminFindTraderCapitalAccountInfo" +
            ...
            "Response")]
        System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.TradersAccountCapitalInfo> AdminFindTraderCapitalAccountInfo(out string strErrorMessage, string adminId, string adminPassword, string traderId);
        ...
        ReckoningCounter.PushBackTest.DoAccountService.MarketDataLevel GetMarketDataInfoByCode(out string errMsg, string code, int breedClassType);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountAndCapitalManagement/GetAllCM_CommodityByBreedClassTyp" +
            ...
            "eIDResponse")]
        System.Collections.Generic.List<string> GetAllCM_CommodityByBreedClassTypeID(int classTypeID, bool isRemoveExpired);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountAndCapitalManagement/AdminPersonalizationCapital", ReplyAction="http://tempuri.org/IAccountAndCapitalManagement/AdminPersonalizationCapitalRespon" +
            "se")]
        bool AdminPersonalizationCapital(out string errMsg, ReckoningCounter.PushBackTest.DoAccountService.CapitalPersonalization model);
        ...
        bool AdminClearTrialData(out string errMsg, ReckoningCounter.PushBackTest.DoAccountService.CapitalPersonalization model);
        ...
        System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.QH_TodaySettlementPriceInfo> GetAllReckoningHoldCode(out string errMsg);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAccountAndCapitalManagementChannel : ReckoningCounter.PushBackTest.DoAccountService.IAccountAndCapitalManagement, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AccountAndCapitalManagementClient : System.ServiceModel.ClientBase<ReckoningCounter.PushBackTest.DoAccountService.IAccountAndCapitalManagement>, ReckoningCounter.PushBackTest.DoAccountService.IAccountAndCapitalManagement {
        ...
        public bool SingleTraderOpenAccount(out string outMessage, System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.AccountEntity> accounts) {
            return base.Channel.SingleTraderOpenAccount(out outMessage, accounts);
        }
        
        public bool VolumeTraderOpenAccount(out string outMessage, System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.AccountEntity> accounts) {
        ...
        public bool DeleteVolumeTraderAccount(out string outMessage, System.Collections.Generic.List<string> userIDs) {
            return base.Channel.DeleteVolumeTraderAccount(out outMessage, userIDs);
        }
        
        public bool FreezeAccount(out string outMessage, System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.FindAccountEntity> accounts) {
            return base.Channel.FreezeAccount(out outMessage, accounts);
        }
        
        public bool ThawAccount(out string outMessage, System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.FindAccountEntity> accounts) {
            return base.Channel.ThawAccount(out outMessage, accounts);
        }
        
        public System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.AccountFindResultEntity> FindAccount(out string outMessage, string traderId, string password) {
            return base.Channel.FindAccount(out outMessage, traderId, password);
        }
        
        public System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.CM_BreedClass> FindTradePrivileges(out string outMessage, string traderId, string password) {
        ...
        public bool AddCapital(out string outMessage, ReckoningCounter.PushBackTest.DoAccountService.AddCapitalEntity addCapital1) {
            return base.Channel.AddCapital(out outMessage, addCapital1);
        }
        
        public bool TwoAccountsFreeTransferFunds(out string outMessage, ReckoningCounter.PushBackTest.DoAccountService.FreeTransferEntity freeTransfer, GTA.VTS.Common.CommonObject.Types.CurrencyType currencyType) {
        ...
        public bool FaultRecoveryReckoning(out string errorMsg, System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.QH_TodaySettlementPriceInfo> list) {
            return base.Channel.FaultRecoveryReckoning(out errorMsg, list);
        }
        
        public long GetSpotMaxOrderAmount(out string outMessage, string TraderId, float OrderPrice, string Code, ReckoningCounter.PushBackTest.DoAccountService.TypesOrderPriceType orderPriceType) {
            return base.Channel.GetSpotMaxOrderAmount(out outMessage, TraderId, OrderPrice, Code, orderPriceType);
        }
        
        public long GetFutureMaxOrderAmount(out string outMessage, string TraderId, float OrderPrice, string Code, ReckoningCounter.PushBackTest.DoAccountService.TypesOrderPriceType orderPriceType) {
            return base.Channel.GetFutureMaxOrderAmount(out outMessage, TraderId, OrderPrice, Code, orderPriceType);
        }
        
        public ReckoningCounter.PushBackTest.DoAccountService.HighLowRangeValue GetHighLowRangeValueByCommodityCode(string code, decimal orderPrice) {
            return base.Channel.GetHighLowRangeValueByCommodityCode(code, orderPrice);
        }
        
        public long GetHKMaxOrderAmount(out string outMessage, string TraderId, float OrderPrice, string Code, GTA.VTS.Common.CommonObject.Types.HKPriceType orderPriceType) {
            return base.Channel.GetHKMaxOrderAmount(out outMessage, TraderId, OrderPrice, Code, orderPriceType);
        }
        
        public ReckoningCounter.PushBackTest.DoAccountService.HighLowRangeValue GetHKHighLowRangeValueByCommodityCode(string code, decimal orderPrice, GTA.VTS.Common.CommonObject.Types.HKPriceType priceType, GTA.VTS.Common.CommonObject.Types.TransactionDirection tranType) {
            return base.Channel.GetHKHighLowRangeValueByCommodityCode(code, orderPrice, priceType, tranType);
        }
        
        public System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.TradersAccountCapitalInfo> AdminFindTraderCapitalAccountInfo(out string strErrorMessage, string adminId, string adminPassword, string traderId) {
            return base.Channel.AdminFindTraderCapitalAccountInfo(out strErrorMessage, adminId, adminPassword, traderId);
        }
        
        public ReckoningCounter.PushBackTest.DoAccountService.MarketDataLevel GetMarketDataInfoByCode(out string errMsg, string code, int breedClassType) {
            return base.Channel.GetMarketDataInfoByCode(out errMsg, code, breedClassType);
        }
        
        public System.Collections.Generic.List<string> GetAllCM_CommodityByBreedClassTypeID(int classTypeID, bool isRemoveExpired) {
            return base.Channel.GetAllCM_CommodityByBreedClassTypeID(classTypeID, isRemoveExpired);
        }
        
        public bool AdminPersonalizationCapital(out string errMsg, ReckoningCounter.PushBackTest.DoAccountService.CapitalPersonalization model) {
            return base.Channel.AdminPersonalizationCapital(out errMsg, model);
        }
        
        public bool AdminClearTrialData(out string errMsg, ReckoningCounter.PushBackTest.DoAccountService.CapitalPersonalization model) {
            return base.Channel.AdminClearTrialData(out errMsg, model);
        }
        
        public System.Collections.Generic.List<ReckoningCounter.PushBackTest.DoAccountService.QH_TodaySettlementPriceInfo> GetAllReckoningHoldCode(out string errMsg) {
