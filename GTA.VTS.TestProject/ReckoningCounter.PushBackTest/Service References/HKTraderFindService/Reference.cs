...
namespace ReckoningCounter.PushBackTest.HKTraderFindService {
    ...
    public partial class HKCapitalEntity : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private ReckoningCounter.PushBackTest.HKTraderFindService.HK_CapitalAccountInfo GTCapitalObjField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ReckoningCounter.PushBackTest.HKTraderFindService.HK_CapitalAccountInfo GTCapitalObj {
            get {
    ...
    public partial class HKHoldFindResultyEntity : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private ReckoningCounter.PushBackTest.HKTraderFindService.HK_AccountHoldInfo HoldFindResultField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ReckoningCounter.PushBackTest.HKTraderFindService.HK_AccountHoldInfo HoldFindResult {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="HKTraderFindService.IHKTraderFind")]
    public interface IHKTraderFind {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHKTraderFind/HKCapitalFind", ReplyAction="http://tempuri.org/IHKTraderFind/HKCapitalFindResponse")]
        ReckoningCounter.PushBackTest.HKTraderFindService.HKCapitalEntity HKCapitalFind(string capitalAccountID, GTA.VTS.Common.CommonObject.Types.CurrencyType currencyType, string userPassword, ref string strErrorMessage);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHKTraderFind/HKHoldFind", ReplyAction="http://tempuri.org/IHKTraderFind/HKHoldFindResponse")]
        System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.HKHoldFindResultyEntity> HKHoldFind(out int count, string capitalAccount, string userPassword, ReckoningCounter.PushBackTest.HKTraderFindService.HKHoldConditionFindEntity findCondition, int start, int pageLength, ref string strErrorMessage);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHKTraderFind/HKTodayEntrustFindByHKCapitalAccount", ReplyAction="http://tempuri.org/IHKTraderFind/HKTodayEntrustFindByHKCapitalAccountResponse")]
        System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.HK_TodayEntrustInfo> HKTodayEntrustFindByHKCapitalAccount(out int count, out string strErrorMessage, string capitalAccount, string userPassword, int start, int pageLength, ReckoningCounter.PushBackTest.HKTraderFindService.HKEntrustConditionFindEntity findCondition);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHKTraderFind/HKHistoryEntrustFind", ReplyAction="http://tempuri.org/IHKTraderFind/HKHistoryEntrustFindResponse")]
        System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.HK_HistoryEntrustInfo> HKHistoryEntrustFind(out int count, out string strErrorMessage, string capitalAccount, string userPassword, int start, int pageLength, ReckoningCounter.PushBackTest.HKTraderFindService.HKEntrustConditionFindEntity findCondition);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHKTraderFind/HKHistoryTradeFind", ReplyAction="http://tempuri.org/IHKTraderFind/HKHistoryTradeFindResponse")]
        System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.HK_HistoryTradeInfo> HKHistoryTradeFind(out int count, out string strErrorMessage, string capitalAccount, string userPassword, int start, int pageLength, ReckoningCounter.PushBackTest.HKTraderFindService.HKTradeConditionFindEntity findCondition);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHKTraderFind/HKTodayTradeFindByCapitalAccount", ReplyAction="http://tempuri.org/IHKTraderFind/HKTodayTradeFindByCapitalAccountResponse")]
        System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.HK_TodayTradeInfo> HKTodayTradeFindByCapitalAccount(out int count, out string strErrorMessage, string capitalAccount, string userPassword, int start, int pageLength, ReckoningCounter.PushBackTest.HKTraderFindService.HKTradeConditionFindEntity findCondition);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHKTraderFind/HKCapitalAccountTransferFlowFind", ReplyAction="http://tempuri.org/IHKTraderFind/HKCapitalAccountTransferFlowFindResponse")]
        System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.UA_CapitalFlowTableInfo> HKCapitalAccountTransferFlowFind(out int count, out string strErrorMessage, string userId, string capitalAccount, string userPassword, System.DateTime startTime, System.DateTime endTime, int start, int pageLength);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IHKTraderFindChannel : ReckoningCounter.PushBackTest.HKTraderFindService.IHKTraderFind, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class HKTraderFindClient : System.ServiceModel.ClientBase<ReckoningCounter.PushBackTest.HKTraderFindService.IHKTraderFind>, ReckoningCounter.PushBackTest.HKTraderFindService.IHKTraderFind {
        
        public HKTraderFindClient() {
        }
        
        public HKTraderFindClient(string endpointConfigurationName) : 
                base(endpointConfigurationName) {
        }
        
        public HKTraderFindClient(string endpointConfigurationName, string remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public HKTraderFindClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public HKTraderFindClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(binding, remoteAddress) {
        }
        
        public ReckoningCounter.PushBackTest.HKTraderFindService.HKCapitalEntity HKCapitalFind(string capitalAccountID, GTA.VTS.Common.CommonObject.Types.CurrencyType currencyType, string userPassword, ref string strErrorMessage) {
            return base.Channel.HKCapitalFind(capitalAccountID, currencyType, userPassword, ref strErrorMessage);
        }
        
        public System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.HKHoldFindResultyEntity> HKHoldFind(out int count, string capitalAccount, string userPassword, ReckoningCounter.PushBackTest.HKTraderFindService.HKHoldConditionFindEntity findCondition, int start, int pageLength, ref string strErrorMessage) {
            return base.Channel.HKHoldFind(out count, capitalAccount, userPassword, findCondition, start, pageLength, ref strErrorMessage);
        }
        
        public System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.HK_TodayEntrustInfo> HKTodayEntrustFindByHKCapitalAccount(out int count, out string strErrorMessage, string capitalAccount, string userPassword, int start, int pageLength, ReckoningCounter.PushBackTest.HKTraderFindService.HKEntrustConditionFindEntity findCondition) {
            return base.Channel.HKTodayEntrustFindByHKCapitalAccount(out count, out strErrorMessage, capitalAccount, userPassword, start, pageLength, findCondition);
        }
        
        public System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.HK_HistoryEntrustInfo> HKHistoryEntrustFind(out int count, out string strErrorMessage, string capitalAccount, string userPassword, int start, int pageLength, ReckoningCounter.PushBackTest.HKTraderFindService.HKEntrustConditionFindEntity findCondition) {
            return base.Channel.HKHistoryEntrustFind(out count, out strErrorMessage, capitalAccount, userPassword, start, pageLength, findCondition);
        }
        
        public System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.HK_HistoryTradeInfo> HKHistoryTradeFind(out int count, out string strErrorMessage, string capitalAccount, string userPassword, int start, int pageLength, ReckoningCounter.PushBackTest.HKTraderFindService.HKTradeConditionFindEntity findCondition) {
            return base.Channel.HKHistoryTradeFind(out count, out strErrorMessage, capitalAccount, userPassword, start, pageLength, findCondition);
        }
        
        public System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.HK_TodayTradeInfo> HKTodayTradeFindByCapitalAccount(out int count, out string strErrorMessage, string capitalAccount, string userPassword, int start, int pageLength, ReckoningCounter.PushBackTest.HKTraderFindService.HKTradeConditionFindEntity findCondition) {
            return base.Channel.HKTodayTradeFindByCapitalAccount(out count, out strErrorMessage, capitalAccount, userPassword, start, pageLength, findCondition);
        }
        
        public System.Collections.Generic.List<ReckoningCounter.PushBackTest.HKTraderFindService.UA_CapitalFlowTableInfo> HKCapitalAccountTransferFlowFind(out int count, out string strErrorMessage, string userId, string capitalAccount, string userPassword, System.DateTime startTime, System.DateTime endTime, int start, int pageLength) {
            return base.Channel.HKCapitalAccountTransferFlowFind(out count, out strErrorMessage, userId, capitalAccount, userPassword, startTime, endTime, start, pageLength);
        }
    }
}
