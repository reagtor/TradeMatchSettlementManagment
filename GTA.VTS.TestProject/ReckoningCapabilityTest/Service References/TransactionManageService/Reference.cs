...
namespace ReckoningCapabilityTest.TransactionManageService {
    ...
    public interface ITransactionManage {
        ...
        System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.UM_UserInfo> BatchAddTransaction(out string message, int Number, ReckoningCapabilityTest.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd);
        ...
        System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.UM_UserInfo> BatchAddTransactionList(out string message, System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.UM_UserInfo> tUserInfo, ReckoningCapabilityTest.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd);
        ...
        bool UpdateTransactionAll(out string message, ReckoningCapabilityTest.TransactionManageService.UM_UserInfo userInfo, string MLoginName, string ManagerPWd);
        ...
        bool BatchDelectTransaction(out string message, System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.UM_UserInfo> userInfo, string MLoginName, string ManagerPWd);
        ...
        ReckoningCapabilityTest.TransactionManageService.CT_Counter TransactionConfirm(out string message, int UserID, string PassWord);
        ...
        bool AddFund(out string message, int UserID, ReckoningCapabilityTest.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd);
        ...
        bool ClearTrialData(out string message, ReckoningCapabilityTest.TransactionManageService.PersonalizationCapital cap, string LoginName, string PassWord);
        ...
        bool PersonalizationCapital(out string message, ReckoningCapabilityTest.TransactionManageService.PersonalizationCapital cap, string LoginName, string PassWord);
        ...
        ReckoningCapabilityTest.TransactionManageService.UM_UserInfo AddTransactionFP(out System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.AccountEntity> l_AccountEntity, out string message, string MLoginName, string ManagerPWd, ReckoningCapabilityTest.TransactionManageService.UM_UserInfo UserInfo, ReckoningCapabilityTest.TransactionManageService.InitFund initfund);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITransactionManage/AdminFindTraderCapitalAccountInfoByIDFP", ReplyAction="http://tempuri.org/ITransactionManage/AdminFindTraderCapitalAccountInfoByIDFPResp" +
            "onse")]
        System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.TradersAccountCapitalInfo> AdminFindTraderCapitalAccountInfoByIDFP(out string strErrorMessage, string adminId, string adminPassword, string traderID);
        ...
        bool AddFundFP(out string mess, ReckoningCapabilityTest.TransactionManageService.UM_FundAddInfo model);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITransactionManageChannel : ReckoningCapabilityTest.TransactionManageService.ITransactionManage, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TransactionManageClient : System.ServiceModel.ClientBase<ReckoningCapabilityTest.TransactionManageService.ITransactionManage>, ReckoningCapabilityTest.TransactionManageService.ITransactionManage {
        ...
        public System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.UM_UserInfo> BatchAddTransaction(out string message, int Number, ReckoningCapabilityTest.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd) {
            return base.Channel.BatchAddTransaction(out message, Number, initFund, MLoginName, ManagerPWd);
        }
        
        public System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.UM_UserInfo> BatchAddTransactionList(out string message, System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.UM_UserInfo> tUserInfo, ReckoningCapabilityTest.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd) {
        ...
        public bool UpdateTransactionAll(out string message, ReckoningCapabilityTest.TransactionManageService.UM_UserInfo userInfo, string MLoginName, string ManagerPWd) {
            return base.Channel.UpdateTransactionAll(out message, userInfo, MLoginName, ManagerPWd);
        }
        
        public bool BatchDelectTransaction(out string message, System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.UM_UserInfo> userInfo, string MLoginName, string ManagerPWd) {
            return base.Channel.BatchDelectTransaction(out message, userInfo, MLoginName, ManagerPWd);
        }
        
        public ReckoningCapabilityTest.TransactionManageService.CT_Counter TransactionConfirm(out string message, int UserID, string PassWord) {
            return base.Channel.TransactionConfirm(out message, UserID, PassWord);
        }
        
        public bool AddFund(out string message, int UserID, ReckoningCapabilityTest.TransactionManageService.InitFund initFund, string MLoginName, string ManagerPWd) {
            return base.Channel.AddFund(out message, UserID, initFund, MLoginName, ManagerPWd);
        }
        
        public bool ClearTrialData(out string message, ReckoningCapabilityTest.TransactionManageService.PersonalizationCapital cap, string LoginName, string PassWord) {
            return base.Channel.ClearTrialData(out message, cap, LoginName, PassWord);
        }
        
        public bool PersonalizationCapital(out string message, ReckoningCapabilityTest.TransactionManageService.PersonalizationCapital cap, string LoginName, string PassWord) {
            return base.Channel.PersonalizationCapital(out message, cap, LoginName, PassWord);
        }
        
        public ReckoningCapabilityTest.TransactionManageService.UM_UserInfo AddTransactionFP(out System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.AccountEntity> l_AccountEntity, out string message, string MLoginName, string ManagerPWd, ReckoningCapabilityTest.TransactionManageService.UM_UserInfo UserInfo, ReckoningCapabilityTest.TransactionManageService.InitFund initfund) {
            return base.Channel.AddTransactionFP(out l_AccountEntity, out message, MLoginName, ManagerPWd, UserInfo, initfund);
        }
        
        public System.Collections.Generic.List<ReckoningCapabilityTest.TransactionManageService.TradersAccountCapitalInfo> AdminFindTraderCapitalAccountInfoByIDFP(out string strErrorMessage, string adminId, string adminPassword, string traderID) {
        ...
        public bool AddFundFP(out string mess, ReckoningCapabilityTest.TransactionManageService.UM_FundAddInfo model) {
