...
namespace MatchCenter.DAL.TransactionManage {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="TransactionManage.ITransactionManage")]
    public interface ITransactionManage {
        ...
        System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.UM_UserInfo> BatchAddTransaction(out string message, int Number, MatchCenter.DAL.TransactionManage.InitFund initFund, string MLoginName, string ManagerPWd);
        ...
        System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.UM_UserInfo> BatchAddTransactionList(out string message, System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.UM_UserInfo> tUserInfo, MatchCenter.DAL.TransactionManage.InitFund initFund, string MLoginName, string ManagerPWd);
        ...
        bool UpdateTransactionAll(out string message, MatchCenter.DAL.TransactionManage.UM_UserInfo userInfo, string MLoginName, string ManagerPWd);
        ...
        bool BatchDelectTransaction(out string message, System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.UM_UserInfo> userInfo, string MLoginName, string ManagerPWd);
        ...
        MatchCenter.DAL.TransactionManage.CT_Counter TransactionConfirm(out string message, int UserID, string PassWord);
        ...
        bool AddFund(out string message, int UserID, MatchCenter.DAL.TransactionManage.InitFund initFund, string MLoginName, string ManagerPWd);
        ...
        bool ClearTrialData(out string message, MatchCenter.DAL.TransactionManage.PersonalizationCapital cap, string LoginName, string PassWord);
        ...
        bool PersonalizationCapital(out string message, MatchCenter.DAL.TransactionManage.PersonalizationCapital cap, string LoginName, string PassWord);
        ...
        MatchCenter.DAL.TransactionManage.UM_UserInfo AddTransactionFP(out System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.AccountEntity> l_AccountEntity, out string message, string MLoginName, string ManagerPWd, MatchCenter.DAL.TransactionManage.UM_UserInfo UserInfo, MatchCenter.DAL.TransactionManage.InitFund initfund);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITransactionManage/AdminFindTraderCapitalAccountInfoByIDFP", ReplyAction="http://tempuri.org/ITransactionManage/AdminFindTraderCapitalAccountInfoByIDFPResp" +
            "onse")]
        System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.TradersAccountCapitalInfo> AdminFindTraderCapitalAccountInfoByIDFP(out string strErrorMessage, string adminId, string adminPassword, string traderID);
        ...
        bool AddFundFP(out string mess, MatchCenter.DAL.TransactionManage.UM_FundAddInfo model);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITransactionManageChannel : MatchCenter.DAL.TransactionManage.ITransactionManage, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TransactionManageClient : System.ServiceModel.ClientBase<MatchCenter.DAL.TransactionManage.ITransactionManage>, MatchCenter.DAL.TransactionManage.ITransactionManage {
        ...
        public System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.UM_UserInfo> BatchAddTransaction(out string message, int Number, MatchCenter.DAL.TransactionManage.InitFund initFund, string MLoginName, string ManagerPWd) {
            return base.Channel.BatchAddTransaction(out message, Number, initFund, MLoginName, ManagerPWd);
        }
        
        public System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.UM_UserInfo> BatchAddTransactionList(out string message, System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.UM_UserInfo> tUserInfo, MatchCenter.DAL.TransactionManage.InitFund initFund, string MLoginName, string ManagerPWd) {
        ...
        public bool UpdateTransactionAll(out string message, MatchCenter.DAL.TransactionManage.UM_UserInfo userInfo, string MLoginName, string ManagerPWd) {
            return base.Channel.UpdateTransactionAll(out message, userInfo, MLoginName, ManagerPWd);
        }
        
        public bool BatchDelectTransaction(out string message, System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.UM_UserInfo> userInfo, string MLoginName, string ManagerPWd) {
            return base.Channel.BatchDelectTransaction(out message, userInfo, MLoginName, ManagerPWd);
        }
        
        public MatchCenter.DAL.TransactionManage.CT_Counter TransactionConfirm(out string message, int UserID, string PassWord) {
            return base.Channel.TransactionConfirm(out message, UserID, PassWord);
        }
        
        public bool AddFund(out string message, int UserID, MatchCenter.DAL.TransactionManage.InitFund initFund, string MLoginName, string ManagerPWd) {
            return base.Channel.AddFund(out message, UserID, initFund, MLoginName, ManagerPWd);
        }
        
        public bool ClearTrialData(out string message, MatchCenter.DAL.TransactionManage.PersonalizationCapital cap, string LoginName, string PassWord) {
            return base.Channel.ClearTrialData(out message, cap, LoginName, PassWord);
        }
        
        public bool PersonalizationCapital(out string message, MatchCenter.DAL.TransactionManage.PersonalizationCapital cap, string LoginName, string PassWord) {
            return base.Channel.PersonalizationCapital(out message, cap, LoginName, PassWord);
        }
        
        public MatchCenter.DAL.TransactionManage.UM_UserInfo AddTransactionFP(out System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.AccountEntity> l_AccountEntity, out string message, string MLoginName, string ManagerPWd, MatchCenter.DAL.TransactionManage.UM_UserInfo UserInfo, MatchCenter.DAL.TransactionManage.InitFund initfund) {
            return base.Channel.AddTransactionFP(out l_AccountEntity, out message, MLoginName, ManagerPWd, UserInfo, initfund);
        }
        
        public System.Collections.Generic.List<MatchCenter.DAL.TransactionManage.TradersAccountCapitalInfo> AdminFindTraderCapitalAccountInfoByIDFP(out string strErrorMessage, string adminId, string adminPassword, string traderID) {
        ...
        public bool AddFundFP(out string mess, MatchCenter.DAL.TransactionManage.UM_FundAddInfo model) {
